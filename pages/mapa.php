        ...
        <div class="col-xs-12">
			<form id="cad" method="POST">
			  <div class="form-group">
			    ...
			    <input type="text" required name="nome" minlength="10" maxlength="60" class="form-control" id="txnome" placeholder="Nome completo"/>
			  </div>
			  <div class="form-group">
			    <label for="txmail">E-mail:</label>
			    <input type="email" required name="email" class="form-control" id="txmail" placeholder="exemplo@email.com"/>
			  </div>
			  <!--	Inclusão de dados adicionais -->
			  <div class="form-group">
			    <label for="txphone">Telefone:</label>
			    <input type="text" required name="telefone" minlength="10" maxlength="11" class="form-control" id="txphone" placeholder="(99) 98765 - 4321"/>
			  </div>

			  <div class="form-group">
			    <label for="txrg">RG:</label>
			    <input type="text" required name="rg" minlength="9" maxlength="9" class="form-control" id="txrg" placeholder="23.456.789 - X"/>
			  </div>
			
			  <div class="form-group">
			    <label for="txcpf">CPF:</label>
			    <input type="text" required minlength="11" maxlength="11" name="cpf" class="form-control" id="txcpf" placeholder="123.456.789 - 00"/>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <textarea class="form-control" required name="denuncia" id="txdenuncia" rows="5" placeholder="Detalhes da denuncia"></textarea>
			  </div>
